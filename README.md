...
For detailed information on supported models, please refer to [supported models](https://docs.vllm.ai/projects/ascend/en/v0.18.0/user_guide/support_matrix/supported_models.html).
