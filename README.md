...
For detailed information on supported models, please refer to [supported models](https://docs.vllm.ai/projects/ascend/en/v0.13.0/user_guide/support_matrix/supported_models.html).
...
- Software:
  * Python >= 3.10, < 3.12
  * CANN == 8.3.rc2 (For Ascend HDK version, please refer to the [Release Notes](https://www.hiascend.com/document/detail/zh/canncommercial/83RC2/releasenote/releasenote_0000.html))
