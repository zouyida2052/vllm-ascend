...
/*!
 * \file sparse_flash_attention_custom_common.h
 * \brief
 */

#ifndef sparse_flash_attention_custom_COMMON_H
#define sparse_flash_attention_custom_COMMON_H
...
#endif // sparse_flash_attention_custom_COMMON_H