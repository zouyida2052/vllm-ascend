...
Using the Qwen2.5-VL-7B-Instruct model as an example, use vllm-ascend v0.18.0 (with vLLM v0.18.0) on 1 Atlas 800T A2 server to deploy the "1P1D" architecture (one Prefiller and one Decoder on the same node). Assume the IP address is 192.0.0.1.
