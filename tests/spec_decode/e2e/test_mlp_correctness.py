...
# TODO: when vllm-ascend supports e2e running in float32 correctly,
# output_len here should be set to 2048 to be consistent with vLLM.
@pytest.mark.parametrize("output_len", [512])
